			...
			<div class="row">
				<div class="tabs-listing">
					...
					<nav>
						<div class="nav nav-tabs d-flex justify-content-center"
							...
							<button class="nav-link text-uppercase active"
								id="nav-reservation-in-tab" data-bs-toggle="tab"
								data-bs-target="#nav-reservation-in" type="button" role="tab"
								aria-controls="nav-reservation-in" aria-selected="true">Reservation
								details</button>
							<!-- Register -->
							<button class="nav-link text-uppercase" id="nav-edituser-tab"
								data-bs-toggle="tab" data-bs-target="#nav-edituser"
								type="button" role="tab" aria-controls="nav-edituser"
					...
					<div class="tab-content" id="nav-tabContent">
						<!-- 예약 목록 -->
						<div class="tab-pane fade active show" id="nav-reservation-in"
							role="tabpanel" aria-labelledby="nav-reservation-in-tab">
							<div class="card">
												...
												<c:otherwise>
													...
													<c:forEach items="${reserve}" var="r">
														<tr>
															...
															<td><fmt:formatNumber value="${r.reservePrice }"
																	type="currency" currencySymbol="￦" /></td>
															<td><span class="btn btn-primary"><strong
																	id="reservation_${r.reserveId }"> <c:choose>
											...
											<form id="formAccountSettings" method="POST"
												...
												<div class="row" id="edituser">
													<div class="mb-3 col-md-6">
														...
														<div class="input-group input-group-merge" style="padding: 0; background-color: #efefef;">
															<input
																type="text" class="w-100" id="id" name="id"
																value="${m.memberId }" readonly="readonly" />
														</div>
													</div>
													<div class="mb-3 col-md-6">
														<label for="firstName" class="form-label">Name</label> <input
															class="w-100" type="text" id="Name" name="Name"
													...
													<div class="mb-3 col-md-6">
														...
														<input
															class="w-100" type="text" id="email" name="email"
															value="${m.memberEmail }"
										...
										<!-- <div class="card" id="withdrawal"> -->
											...
											<div class="card-body">
												<div class="mb-3 col-12 mb-0">
													<div class="alert alert-warning" id="alertwarning" style="background-color: #efefef; border: none; color: #212529;">
														<h4 class="alert-heading fw-bold mb-1" style="font-family: 'Noto Sans KR', sans-serif; font-weight: 800; color: #87826e">
														정말로 탈퇴하시겠습니까?</h4>
														<br>
												...
												<form id="formAccountDeactivation" onsubmit="return false">
													<div class="form-check mb-3">
														<input class="form-check-input" type="checkbox"
															...
															class="form-check-label" for="accountActivation"  style="font-family: 'Noto Sans KR', sans-serif; font-weight: 400">
															회원탈퇴에 동의합니다.</label>
													</div>
													<div class="mt-2" style="float: right;">
