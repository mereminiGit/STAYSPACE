...
<body>
	...
	<aside id="layout-menu"
		...
		<ul class="menu-inner py-1">
			...
			<!-- Member Management -->
			<li class="menu-item"><a href="businessmemberpage.do"
			...
			<li class="menu-item"><a href="javascript:void(0);"
				...
				<ul class="menu-sub">
					<li class="menu-item"><a href="BusinessSpaceList.do"
						class="menu-link">
							<div data-i18n="Basic Inputs">Space List</div>
					</a></li>
					<li class="menu-item"><a href="registerspace.do"
						class="menu-link">
							<div data-i18n="Input groups">Register Space</div>
					</a></li>
					<li class="menu-item"><a href="spacewaiting.do"
						class="menu-link">
			...
			<li class="menu-item"><a href="reservelist.do" class="menu-link">
